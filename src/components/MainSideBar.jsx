...
export default function MainSideBar() {
  return (
    <aside className="flex flex-col-2 w-[240px] h-full fixed p-5 border  bg-gray-200">
      <div className=" h-[80px]">
        ...
        <div className="grid grid-row-3 mt-4">
          ...
          <ul class="mt-4 font-bold text-[#31456A]">
            <li class="  hover:shadow  hover:bg-blue-500 hover:rounded-2xl hover:text-white py-2 mb-2 ">
              <a href="#" class="px-3">
                <BiCategory class="inline-block w-5 h-5 -mt-1 mr-2 " />
                Dashboard
              </a>
            </li>
            <li class="grid hover:shadow  hover:bg-blue-500 hover:rounded-2xl hover:text-white py-2 mb-2 ">
              <a href="#" class="px-3">
      ...
      <div className="flex flex-grow items-center ml-1 justify-end">
        <IoArrowBackCircle className="text-3xl text-gray-400 hover:text-blue-500" />
      </div>
    </aside>
  );
}
